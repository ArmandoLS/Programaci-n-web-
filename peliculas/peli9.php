...
<style>
    .header {
    position: relative; 
    background-image: url(img2/9_1.jpg);
        ...
        <div class="header-content container">
            ...
            <div class="movie-info">
                ...
                if ($result->num_rows > 0) {
                    ...
                    echo '<img src="img2/9.jpg" alt="' . $row["titulo"] . '">';
                    ...
                    echo '<a href="https://www.youtube.com/watch?v=IJD1VktHJSw" class="btn-2">Ver Trailer</a>';
                    echo '</div>';
                } else {
