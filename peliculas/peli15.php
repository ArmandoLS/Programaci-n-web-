...
<style>
    .header {
    position: relative; 
    background-image: url(img2/15_1.jpg);
...
<body>
    ...
    <header class="header">
        <div class="menu container">
            <a href="/index.html" class="logo">CINEMA CLUB 🎬</a>
        ...
        <div class="header-content container">
            ...
            <div class="movie-info">
                ...
                if ($result->num_rows > 0) {
                    ...
                    echo '<img src="img2/15.png" alt="' . $row["titulo"] . '">';
    ...
    <div class="movie-container">
        ...
        <a href="/Sala/Sala4.html"><button class="confirm-button">Comprar Boletos</button> </a>
    </div>
