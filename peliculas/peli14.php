...
<style>
    .header {
    position: relative; 
    background-image: url(img2/14_1.jpg);
...
<body>
        ...
        <div class="header-content container">
            ...
            <div class="movie-info">
                ...
                if ($result->num_rows > 0) {
                    ...
                    echo '<img src="img2/14.jpg" alt="' . $row["titulo"] . '">';
                    ...
                    echo '<a href="https://www.youtube.com/watch?v=zh4KhVSMwtQ" class="btn-2">Ver Trailer</a>';
                    echo '</div>';
                } else {
    ...
    <div class="movie-container">
        ...
        <a href="/Sala/Sala3.html"><button class="confirm-button">Comprar Boletos</button> </a>
    </div>
