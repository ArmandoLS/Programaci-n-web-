...
<style>
    .header {
    position: relative; 
    background-image: url(img2/12_1.jpg);
        ...
        <div class="header-content container">
            ...
            <div class="movie-info">
                ...
                if ($result->num_rows > 0) {
                    ...
                    echo '<img src="img2/12.jpg" alt="' . $row["titulo"] . '">';
                    ...
                    echo '<a href="https://www.youtube.com/watch?v=M8W_y0mmJEc" class="btn-2">Ver Trailer</a>';
                    echo '</div>';
                } else {
